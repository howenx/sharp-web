...
public class ErrorHandler implements HttpErrorHandler {
    public CompletionStage<Result> onClientError(RequestHeader request, int statusCode, String message) {
        ...
        if (statusCode == play.mvc.Http.Status.NOT_FOUND) {
            ...
            CompletableFuture.completedFuture(ok(views.html.error404.render()));
            ...
            return CompletableFuture.completedFuture(ok(views.html.error500.render()));
        }
        return CompletableFuture.completedFuture(ok(views.html.error404.render()));
    }
